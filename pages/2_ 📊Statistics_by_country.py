...
from loader import data, data_2023, Save
...
try:
    if st.sidebar.button("Predict NaN data", type="primary") or Save.predict:
    ...
    columns = st.sidebar.multiselect("Select Columns to Display", options=available_columns, default=[available_columns[0]])
    ...
    with col3:
        ...
        donut_chart_gdp = make_donut(g, 'GDP (current US$) raise')
    ...
    st.write('Oh something wron pleas try again!')